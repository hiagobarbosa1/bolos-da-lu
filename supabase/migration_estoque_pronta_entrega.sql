...
-- Cria um checkout atômico: o pedido e a baixa de estoque acontecem juntos.
...
begin
  ...
  insert into public.pedidos (usuario_id, data_entrega, endereco, valor_total)
  values (auth.uid(), p_data_entrega, p_endereco, 0)
...
grant execute on function public.finalizar_pedido_pronta_entrega(date, text, jsonb) to authenticated;
